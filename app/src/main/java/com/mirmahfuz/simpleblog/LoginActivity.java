...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginPasswordField = (EditText) findViewById(R.id.loginpasswprdField);
        mLoginRegister = (Button) findViewById(R.id.loginRegister);


        // To get Register Page Here By Mee
        ...
        mLoginRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openRegister.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
